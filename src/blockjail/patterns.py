...
PATTERNS: list[tuple[str, str]] = [
    ...
    # Deposition / legal / onboarding soft (wave-11)
    ...
    (r"پرامپت\s*سیستم|سيستم\s*پرامپت", "fa_system_prompt"),
    (r"نادیده\s*بگیر", "fa_override"),
    # Ritual / HR / clearance soft (wave-12)
    ...
    # Dream / factory / birth soft (wave-14)
    ...
    # Ghost / autopsy / factory / doctrine (wave-15)
    ...
    # Constitution / ceremony / vault soft (wave-16)
    ...
    # Soft metaphor class (wave-17): soul-mirror / recorder / notary / supervisor
